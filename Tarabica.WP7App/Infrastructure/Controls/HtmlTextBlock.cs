/* http://krempelwp7.codeplex.com/releases/view/84496 */
...
namespace Tarabica.WP7App.Infrastructure.Controls
{
    ...
    public class HtmlTextBlock : Control
    {
        ...
        private void AppendRichtextBox(HtmlNode node)
        {
            ...
            // boca hardkodovao :)
            rtb.Foreground = new SolidColorBrush(Color.FromArgb(0xff, 0xff, 0xff, 0xff));
        ...
        private void AppendHyperlink(HtmlNode node, Paragraph paragraph, Span span)
        {
            ...
            // boca hardkodovao :)
            hyperlink.Foreground = new SolidColorBrush(Color.FromArgb(0xff, 0xff, 0xff, 0xff));
